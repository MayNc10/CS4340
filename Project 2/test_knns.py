...
data_set_colors = np.array(["red", "green"])
data_set_markers = np.array(["x", "o"])
for idx in range(len(x)):   
    plt.scatter(x[idx], y[idx], c=data_set_colors[class_data[idx]], marker=data_set_markers[class_data[idx]])
